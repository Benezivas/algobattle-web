  ...
  <tr>
    ...
    <td>
      <template v-if="file.location">
        ...
        <button v-if="removable" type="button" class="btn btn-sm btn-danger" @click="removeFile">Remove</button>
      </template>
    </td>
    <input type="file" class="form-control form-control-sm w-em" id="prob_file" ref="fileSelect" @change="(e) => selectFile(e as any)"/>
  </tr>
</template>
