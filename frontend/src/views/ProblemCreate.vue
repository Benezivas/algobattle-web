  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col mx-0" style="max-width: 40rem;">
        ...
        <div class="card">
          <form v-if="page == 0" id="file_form" ref="file_form" class="card-body" @submit.prevent="sendFile" novalidate>
            ...
            <FileInput class="w-em mb-2" id="prob_file" v-model="data.file" @change="(e: any) => data.copyFrom = undefined"/>
          ...
          <form v-if="page == 2" id="docs_form" ref="docs_form" class="card-body" @submit.prevent="e => page++">
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <textarea class="form-control" id="prob_schema" rows="10" v-model="data.problemSchema"></textarea>
            </div>
          ...
          <form v-if="page == 3" id="display_form" ref="display_form" class="card-body" @submit.prevent="createProblem">
            <div class="row">
              <div class="col-5">
                ...
                <div class="mb-3">
                  ...
                  <textarea class="form-control w-em" name="alt_text" id="alt_text" rows="5" v-model="data.alt" />
                </div>
                <div class="mb-3">
                  <label for="short_desc" class="form-label">Short description</label>
                  <textarea class="form-control w-em" name="short_description" id="short_desc" rows="5" v-model="data.shortDescription"></textarea>
                </div>
                <div class="mb-3">
                  <label for="prob_col" class="form-label">Problem colour</label>
                  <input type="color" name="colour" class="form-control form-control-color" id="prob_col" v-model="data.color"/>
                </div>
              </div>
              <div class="col-7">
                <h3>Card preview</h3>
                <div class="card m-2 border border-5" style="width: 18rem; height: 24rem;" :style="{borderColor: data.color + ' !important'}">
                  <img v-if="data.image" :src="imageUrl" class="card-img-top object-fit-cover" style="height: 10.125rem" :style="{backgroundColor: data.color + ' !important'}" :alt="data.alt">
...
#progressbar .set, #progressbar .active {
    color: #000000;
}
...
#progressbar .active i.progress-icon, #progressbar li.active:after {
    background: mediumturquoise;
}

#progressbar .set i.progress-icon, #progressbar li.set:after {
