...
<template>
      ...
      <tr v-for="tournament in tournaments">
        ...
        <td class="text-end">
          <button
            ...
            @click="(e) => openModal('edit', tournament)"
          >
  ...
  <button type="button" class="btn btn-primary btn-sm ms-2" @click="(e) => openModal('create', null)">
    ...
    <div class="modal-dialog modal-dialog-centered">
      <form class="modal-content" @submit.prevent="submitEdit">
        ...
        <div class="modal-body">
          ...
          />
          <div class="invalid-feedback">Another tournament with that name exists already</div>
        </div>
        <div class="modal-footer">
          <button
            v-if="data.confirmDelete"
            type="button"
            class="btn btn-secondary"
            @click="(e) => (data.confirmDelete = false)"
          >
            Cancel
          </button>
          <button
